...
export type ClusterMarkersBlockContract = BlockContract;
export type ClusterMarkersBlockOutputs  = BlockOutputs;
export type ClusterMarkersBlockData     = BlockData;
export const ClusterMarkersBlockPointer = BlockPointer;
